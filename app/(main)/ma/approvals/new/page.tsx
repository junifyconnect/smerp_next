...
export default function NewMAApprovalPage() {
  ...
  const [items, setItems] = useState<MAApprovalItem[]>([
    { smCode: '', vendorCode: '', clientCompany: '', salesCompany: '', salesPrice: 0, quantity: 1, salesBillingType: '일시불', startDate: '', endDate: '', purchaseCompany: '', purchasePrice: 0, purchaseBillingType: '총(월간)' },
  ])
  ...
  const addItem = () => {
    setItems([...items, { smCode: '', vendorCode: '', clientCompany: '', salesCompany: '', salesPrice: 0, quantity: 1, salesBillingType: '일시불', startDate: '', endDate: '', purchaseCompany: '', purchasePrice: 0, purchaseBillingType: '총(월간)' }])
  }
